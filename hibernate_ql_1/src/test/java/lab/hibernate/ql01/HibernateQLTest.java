...
//			System.out.println(t.getCategory().getName());
	...
	public void testHQL_12() {
		Session session = sf.openSession();
		session.beginTransaction();
		Query q = session.createQuery("select new lab.hibernate.ql01.MsgInfo(m.id, m.cont, m.topic.title, m.topic.category.name) from Msg m");
